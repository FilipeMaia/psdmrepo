...
class  psana_image ( object ) :
    ...
    def __init__ ( self,
        ...
        print "psana_image, %d sources: " % nsources
    ...
    def beginjob ( self, evt, env ) : 
        logging.info( "psana_image.beginjob()" )
    ...
    def event ( self, evt, env ) :
        logging.debug( "psana_image.event()" )
    ...
    def endjob( self, evt, env ) :
        logging.info( "psana_image.endjob()" )
