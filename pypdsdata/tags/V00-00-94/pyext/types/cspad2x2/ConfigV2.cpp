...
namespace {
  ...
  ENUM_FUN0_WRAPPER(pypdsdata::CsPad2x2::ConfigV2, inactiveRunMode, runModesEnum)
  ENUM_FUN0_WRAPPER(pypdsdata::CsPad2x2::ConfigV2, activeRunMode, runModesEnum)
  FUN0_WRAPPER(pypdsdata::CsPad2x2::ConfigV2, payloadSize)
  FUN0_WRAPPER(pypdsdata::CsPad2x2::ConfigV2, badAsicMask)
  FUN0_WRAPPER(pypdsdata::CsPad2x2::ConfigV2, asicMask)
  FUN0_WRAPPER(pypdsdata::CsPad2x2::ConfigV2, roiMask)
  FUN0_WRAPPER(pypdsdata::CsPad2x2::ConfigV2, runTriggerDelay)
  ...
  PyMethodDef methods[] = {
    ...
    {"runTriggerDelay",     runTriggerDelay,     METH_NOARGS, "self.runTriggerDelay() -> int\n\nRetuns integer number" },
  ...
  char typedoc[] = "Python class wrapping C++ Pds::CsPad2x2::ConfigV2 class.";
}
...
void
pypdsdata::CsPad2x2::ConfigV2::initType( PyObject* module )
{
...
{
  const Pds::CsPad2x2::ConfigV2* obj = pypdsdata::CsPad2x2::ConfigV2::pdsObject( self );
  if ( not obj ) return 0;
