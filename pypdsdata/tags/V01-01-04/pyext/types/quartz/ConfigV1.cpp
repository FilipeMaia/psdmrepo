...
namespace {
  ...
  pypdsdata::EnumType::Enum depthEnumValues[] = {
      { "Eight_bit",  Pds::Quartz::ConfigV1::Eight_bit },
      { "Ten_bit",    Pds::Quartz::ConfigV1::Ten_bit },
      { 0, 0 }
  };
  pypdsdata::EnumType depthEnum ( "Depth", depthEnumValues );

  pypdsdata::EnumType::Enum binningEnumValues[] = {
      { "x1", Pds::Quartz::ConfigV1::x1 },
      { "x2", Pds::Quartz::ConfigV1::x2 },
      { "x4", Pds::Quartz::ConfigV1::x4 },
      { 0, 0 }
  };
  pypdsdata::EnumType binningEnum ( "Binning", binningEnumValues );

  pypdsdata::EnumType::Enum mirroringEnumValues[] = {
      { "None",   Pds::Quartz::ConfigV1::None },
      { "HFlip",  Pds::Quartz::ConfigV1::HFlip },
      { "VFlip",  Pds::Quartz::ConfigV1::VFlip },
      { "HVFlip", Pds::Quartz::ConfigV1::HVFlip },
      { 0, 0 }
  };
  ...
  pypdsdata::TypeLib::EnumEntry enums[] = {
        { "LUT_Size", Pds::Quartz::ConfigV1::LUT_Size },

        { "Row_Pixels", Pds::Quartz::ConfigV1::Row_Pixels },

        { "Column_Pixels", Pds::Quartz::ConfigV1::Column_Pixels },

        { 0, 0 }
  };

  // methods
  FUN0_WRAPPER(pypdsdata::Quartz::ConfigV1, black_level)
  FUN0_WRAPPER(pypdsdata::Quartz::ConfigV1, gain_percent)
  FUN0_WRAPPER(pypdsdata::Quartz::ConfigV1, output_offset)
  ENUM_FUN0_WRAPPER(pypdsdata::Quartz::ConfigV1, output_resolution, depthEnum)
  FUN0_WRAPPER(pypdsdata::Quartz::ConfigV1, output_resolution_bits)
  ENUM_FUN0_WRAPPER(pypdsdata::Quartz::ConfigV1, vertical_binning, binningEnum)
  ENUM_FUN0_WRAPPER(pypdsdata::Quartz::ConfigV1, horizontal_binning, binningEnum)
  ENUM_FUN0_WRAPPER(pypdsdata::Quartz::ConfigV1, output_mirroring, mirroringEnum)
  FUN0_WRAPPER(pypdsdata::Quartz::ConfigV1, defect_pixel_correction_enabled)
  FUN0_WRAPPER(pypdsdata::Quartz::ConfigV1, output_lookup_table_enabled)
  FUN0_WRAPPER(pypdsdata::Quartz::ConfigV1, number_of_defect_pixels)
  FUN0_WRAPPER(pypdsdata::Quartz::ConfigV1, defect_pixel_coordinates)
  ...
  PyMethodDef methods[] = {
    ...
    {"gain_percent",      gain_percent,      METH_NOARGS,  
        "self.gain_percent() -> int\n\nReturns camera gain setting in percentile [100-800] = [1x-8x]." },
    ...
    {"horizontal_binning",  horizontal_binning,  METH_NOARGS,
        "self.horizontal_binning() -> Binning enum\n\nReturns horizontal re-binning of output (consecutive rows summed), one of :py:class:`Binning` enums" },
  ...
  char typedoc[] = "Python class wrapping C++ Pds::Quartz::ConfigV1 class.";
}
...
void
pypdsdata::Quartz::ConfigV1::initType( PyObject* module )
{
...
void
pypdsdata::Quartz::ConfigV1::print(std::ostream& str) const
{
  str << "quartz.ConfigV1(black_level=" << m_obj->black_level()
...
{
  const Pds::Quartz::ConfigV1* obj = pypdsdata::Quartz::ConfigV1::pdsObject( self );
  if ( not obj ) return 0;
  ...
  // dimensions
  npy_intp dims[1] = { obj->output_lookup_table_enabled() ? Pds::Quartz::ConfigV1::LUT_Size : 0 };
