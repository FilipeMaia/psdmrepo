...
namespace {
  ...
  pypdsdata::EnumType::Enum speedEnumValues[] = {
      { "ReadoutSpeed_Slow",  Pds::Timepix::ConfigV3::ReadoutSpeed_Slow },
      { "ReadoutSpeed_Fast",  Pds::Timepix::ConfigV3::ReadoutSpeed_Fast },
      { 0, 0 }
  };
  pypdsdata::EnumType speedEnum ( "ReadoutSpeed", speedEnumValues );

  pypdsdata::EnumType::Enum timepixModeEnumValues[] = {
      { "TimepixMode_Counting", Pds::Timepix::ConfigV3::TimepixMode_Counting },
      { "TimepixMode_TOT",      Pds::Timepix::ConfigV3::TimepixMode_TOT },
      { 0, 0 }
  };
  pypdsdata::EnumType timepixModeEnum ( "TimepixMode", timepixModeEnumValues );


  // list of enums
  pypdsdata::TypeLib::EnumEntry enums[] = {
        { "ChipCount", Pds::Timepix::ConfigV3::ChipCount },
        { "ChipNameMax", Pds::Timepix::ConfigV3::ChipNameMax },
        { "PixelThreshMax", Pds::Timepix::ConfigV3::PixelThreshMax },
        { 0, 0 }
  };

  // methods
  ENUM_FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, readoutSpeed, speedEnum)
  ENUM_FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, timepixMode, timepixModeEnum)
  FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, timepixSpeed)

  FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, dac0Ikrum)
  FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, dac0Disc)
  FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, dac0Preamp)
  FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, dac0BufAnalogA)
  FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, dac0BufAnalogB)
  FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, dac0Hist)
  FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, dac0ThlFine)
  FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, dac0ThlCourse)
  FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, dac0Vcas)
  FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, dac0Fbk)
  FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, dac0Gnd)
  FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, dac0Ths)
  FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, dac0BiasLvds)
  FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, dac0RefLvds)
  FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, dac1Ikrum)
  FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, dac1Disc)
  FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, dac1Preamp)
  FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, dac1BufAnalogA)
  FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, dac1BufAnalogB)
  FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, dac1Hist)
  FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, dac1ThlFine)
  FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, dac1ThlCourse)
  FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, dac1Vcas)
  FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, dac1Fbk)
  FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, dac1Gnd)
  FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, dac1Ths)
  FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, dac1BiasLvds)
  FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, dac1RefLvds)
  FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, dac2Ikrum)
  FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, dac2Disc)
  FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, dac2Preamp)
  FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, dac2BufAnalogA)
  FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, dac2BufAnalogB)
  FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, dac2Hist)
  FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, dac2ThlFine)
  FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, dac2ThlCourse)
  FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, dac2Vcas)
  FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, dac2Fbk)
  FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, dac2Gnd)
  FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, dac2Ths)
  FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, dac2BiasLvds)
  FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, dac2RefLvds)
  FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, dac3Ikrum)
  FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, dac3Disc)
  FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, dac3Preamp)
  FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, dac3BufAnalogA)
  FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, dac3BufAnalogB)
  FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, dac3Hist)
  FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, dac3ThlFine)
  FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, dac3ThlCourse)
  FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, dac3Vcas)
  FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, dac3Fbk)
  FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, dac3Gnd)
  FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, dac3Ths)
  FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, dac3BiasLvds)
  FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, dac3RefLvds)
  FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, dacBias)
  FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, flags)
  FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, chipCount)
  FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, driverVersion)
  FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, firmwareVersion)
  FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, pixelThreshSize)
  FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, chip0Name)
  FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, chip1Name)
  FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, chip2Name)
  FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, chip3Name)
  FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, chip0ID)
  FUN0_WRAPPER(pypdsdata::Timepix::ConfigV3, chip1ID)
  ...
  PyMethodDef methods[] = {
    ...
    { "timepixMode",       timepixMode         , METH_NOARGS,  "self.timepixMode() -> TimepixMode enum\n\nReturns :py:class:`TimepixMode` enum" },
    ...
    { "dacBias",           dacBias             , METH_NOARGS,  "self.dacBias() -> int\n\nReturns integer number" },
    { "flags",             flags               , METH_NOARGS,  "self.flags() -> int\n\nReturns integer number" },
  ...
  char typedoc[] = "Python class wrapping C++ Pds::Timepix::ConfigV3 class.";
}
...
void
pypdsdata::Timepix::ConfigV3::initType( PyObject* module )
{
  ...
  PyDict_SetItemString( tp_dict, "TimepixMode", timepixModeEnum.type() );
...
pixelThresh(PyObject *self, PyObject*)
{
  ...
  // dimensions
  npy_intp dims[1] = { Pds::Timepix::ConfigV3::PixelThreshMax };
