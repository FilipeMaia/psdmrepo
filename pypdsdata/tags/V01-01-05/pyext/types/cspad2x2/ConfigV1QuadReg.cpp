...
namespace {
  ...
  // methods
  FUN0_WRAPPER(pypdsdata::CsPad2x2::ConfigV1QuadReg, shiftSelect)
  FUN0_WRAPPER(pypdsdata::CsPad2x2::ConfigV1QuadReg, edgeSelect)
  ...
  FUN0_WRAPPER(pypdsdata::CsPad2x2::ConfigV1QuadReg, ro)
...
{
  str << "cspad2x2.ConfigV1QuadReg(shiftSelect=" << m_obj->shiftSelect()
