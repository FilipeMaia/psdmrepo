...
void
pypdsdata::Pulnix::TM6740ConfigV1::print(std::ostream& str) const
{
  str << "pulnix.TM6740ConfigV2(vref=" << m_obj->vref()
      << ", gain_a=" << m_obj->gain_a()
      << ", gain_b=" << m_obj->gain_b()
      << ", bits=" << m_obj->output_resolution_bits()
      << ", shutter_width=" << m_obj->shutter_width()
      << ", ...)" ;
}
