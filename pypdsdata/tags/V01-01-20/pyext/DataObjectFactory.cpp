...
#include "types/bld/BldDataEBeamV5.h"
#include "types/bld/BldDataEBeamV6.h"
...
DataObjectFactory::makeObject( const Pds::Xtc& xtc, PyObject* parent )
{
  ...
  case Pds::TypeId::Id_EBeam :
    ...
    if ( not obj ) obj = xtc2obj<Bld::BldDataEBeamV5, 5>(xtc, parent);
    if ( not obj ) obj = xtc2obj<Bld::BldDataEBeamV6, 6>(xtc, parent);
    break ;
  ...
  case Pds::TypeId::Id_EpixSamplerConfig :
    if ( not obj ) obj = xtc2obj<EpixSampler::ConfigV1, 1>(xtc, parent);
    break;
