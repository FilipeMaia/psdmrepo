...
namespace {
  ...
  PyMethodDef methods[] = {
    { "sync_source",   sync_source,  METH_NOARGS, "" },
    { "beam_source",   beam_source,  METH_NOARGS, "" },
    { "length",        length,       METH_NOARGS, "" },
    { "cycles",        cycles,       METH_NOARGS, "" },
    { "entries",       entries,      METH_NOARGS, "" },
    { "entry",         entry,        METH_VARARGS, "" },
    {0, 0, 0, 0}
   };
