 ...
 *  @ingroup RootHist
 *  
 *  @brief Implementation of PSHist::Tuple interface.
 *  
...
private:
  ...
  TTree *m_tuple;   ///< Corresponding ROOT tuple object
  std::map<std::string, PSHist::Column*> m_columns;  ///< Names and columns created by this instance
