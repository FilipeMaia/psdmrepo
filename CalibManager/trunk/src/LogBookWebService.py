...
#----------------------------------
#(inst='AMO', exp='amodaq09', run='825', tag='TAG1',
...
class LogBookWebService :
    ...
    def get_list_of_tags(self) :
        list_raw = self.logbook_experiments[self.exp]['tags']
        list_str = []
        for tag in list_raw :
...
def test_LogBookWebService() :
    ...
    sys.exit('Success! End of test_LogBookWebService.')
