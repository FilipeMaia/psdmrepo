...
@version $Id: SvnProps.py 9213 2014-11-06 01:05:50Z dubrovin@SLAC.STANFORD.EDU $
...
class SvnProps :
    def __init__(self) : 
        ...
        self.id       = "$Id: SvnProps.py 9213 2014-11-06 01:05:50Z dubrovin@SLAC.STANFORD.EDU $"
        self.headurl  = "$HeadURL: https://pswww.slac.stanford.edu/svn/psdmrepo/CalibManager/trunk/src/SvnProps.py $"
        self.header   = "$Header:$"
        self.datelc   = "$LastChangedDate: 2014-11-05 17:05:50 -0800 (Wed, 05 Nov 2014) $"
        self.date     = "$Date: 2014-11-05 17:05:50 -0800 (Wed, 05 Nov 2014) $"
