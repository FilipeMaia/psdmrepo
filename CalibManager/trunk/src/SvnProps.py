...
@version $Id: SvnProps.py 8511 2014-06-30 16:33:16Z dubrovin@SLAC.STANFORD.EDU $
...
class SvnProps :
    def __init__(self) : 
        ...
        self.id       = "$Id: SvnProps.py 8511 2014-06-30 16:33:16Z dubrovin@SLAC.STANFORD.EDU $"
        self.headurl  = "$HeadURL: https://pswww.slac.stanford.edu/svn/psdmrepo/CalibManager/trunk/src/SvnProps.py $"
        self.header   = "$Header:$"
        self.datelc   = "$LastChangedDate: 2014-06-30 09:33:16 -0700 (Mon, 30 Jun 2014) $"
        self.date     = "$Date: 2014-06-30 09:33:16 -0700 (Mon, 30 Jun 2014) $"
