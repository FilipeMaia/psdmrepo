...
@version $Id: SvnProps.py 8314 2014-06-03 21:04:04Z dubrovin@SLAC.STANFORD.EDU $
...
class SvnProps :
    def __init__(self) : 
        ...
        self.id       = "$Id: SvnProps.py 8314 2014-06-03 21:04:04Z dubrovin@SLAC.STANFORD.EDU $"
        self.headurl  = "$HeadURL: https://pswww.slac.stanford.edu/svn/psdmrepo/CalibManager/trunk/src/SvnProps.py $"
        self.header   = "$Header:$"
        self.datelc   = "$LastChangedDate: 2014-06-03 14:04:04 -0700 (Tue, 03 Jun 2014) $"
        self.date     = "$Date: 2014-06-03 14:04:04 -0700 (Tue, 03 Jun 2014) $"
