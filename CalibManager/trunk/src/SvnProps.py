...
@version $Id: SvnProps.py 8358 2014-06-10 16:34:34Z dubrovin@SLAC.STANFORD.EDU $
...
class SvnProps :
    def __init__(self) : 
        ...
        self.id       = "$Id: SvnProps.py 8358 2014-06-10 16:34:34Z dubrovin@SLAC.STANFORD.EDU $"
        self.headurl  = "$HeadURL: https://pswww.slac.stanford.edu/svn/psdmrepo/CalibManager/trunk/src/SvnProps.py $"
        self.header   = "$Header:$"
        self.datelc   = "$LastChangedDate: 2014-06-10 09:34:34 -0700 (Tue, 10 Jun 2014) $"
        self.date     = "$Date: 2014-06-10 09:34:34 -0700 (Tue, 10 Jun 2014) $"
