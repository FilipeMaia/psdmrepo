...
@version $Id: SvnProps.py 8967 2014-09-26 21:15:30Z dubrovin@SLAC.STANFORD.EDU $
...
class SvnProps :
    def __init__(self) : 
        ...
        self.id       = "$Id: SvnProps.py 8967 2014-09-26 21:15:30Z dubrovin@SLAC.STANFORD.EDU $"
        self.headurl  = "$HeadURL: https://pswww.slac.stanford.edu/svn/psdmrepo/CalibManager/trunk/src/SvnProps.py $"
        self.header   = "$Header:$"
        self.datelc   = "$LastChangedDate: 2014-09-26 14:15:30 -0700 (Fri, 26 Sep 2014) $"
        self.date     = "$Date: 2014-09-26 14:15:30 -0700 (Fri, 26 Sep 2014) $"
