...
@version $Id: SvnProps.py 8505 2014-06-27 23:55:36Z dubrovin@SLAC.STANFORD.EDU $
...
class SvnProps :
    def __init__(self) : 
        ...
        self.id       = "$Id: SvnProps.py 8505 2014-06-27 23:55:36Z dubrovin@SLAC.STANFORD.EDU $"
        self.headurl  = "$HeadURL: https://pswww.slac.stanford.edu/svn/psdmrepo/CalibManager/trunk/src/SvnProps.py $"
        self.header   = "$Header:$"
        self.datelc   = "$LastChangedDate: 2014-06-27 16:55:36 -0700 (Fri, 27 Jun 2014) $"
        self.date     = "$Date: 2014-06-27 16:55:36 -0700 (Fri, 27 Jun 2014) $"
