...
@version $Id: SvnProps.py 9145 2014-10-24 17:36:20Z dubrovin@SLAC.STANFORD.EDU $
...
class SvnProps :
    def __init__(self) : 
        ...
        self.id       = "$Id: SvnProps.py 9145 2014-10-24 17:36:20Z dubrovin@SLAC.STANFORD.EDU $"
        self.headurl  = "$HeadURL: https://pswww.slac.stanford.edu/svn/psdmrepo/CalibManager/trunk/src/SvnProps.py $"
        self.header   = "$Header:$"
        self.datelc   = "$LastChangedDate: 2014-10-24 10:36:20 -0700 (Fri, 24 Oct 2014) $"
        self.date     = "$Date: 2014-10-24 10:36:20 -0700 (Fri, 24 Oct 2014) $"
