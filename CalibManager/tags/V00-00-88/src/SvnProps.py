...
@version $Id: SvnProps.py 9233 2014-11-11 18:43:45Z dubrovin@SLAC.STANFORD.EDU $
...
class SvnProps :
    def __init__(self) : 
        ...
        self.id       = "$Id: SvnProps.py 9233 2014-11-11 18:43:45Z dubrovin@SLAC.STANFORD.EDU $"
        self.headurl  = "$HeadURL: https://pswww.slac.stanford.edu/svn/psdmrepo/CalibManager/trunk/src/SvnProps.py $"
        self.header   = "$Header:$"
        self.datelc   = "$LastChangedDate: 2014-11-11 10:43:45 -0800 (Tue, 11 Nov 2014) $"
        self.date     = "$Date: 2014-11-11 10:43:45 -0800 (Tue, 11 Nov 2014) $"
