...
@version $Id: SvnProps.py 8443 2014-06-18 00:04:30Z dubrovin@SLAC.STANFORD.EDU $
...
class SvnProps :
    def __init__(self) : 
        ...
        self.id       = "$Id: SvnProps.py 8443 2014-06-18 00:04:30Z dubrovin@SLAC.STANFORD.EDU $"
