...
@version $Id: SvnProps.py 8525 2014-07-02 21:46:47Z dubrovin@SLAC.STANFORD.EDU $
...
class SvnProps :
    def __init__(self) : 
        ...
        self.id       = "$Id: SvnProps.py 8525 2014-07-02 21:46:47Z dubrovin@SLAC.STANFORD.EDU $"
        self.headurl  = "$HeadURL: https://pswww.slac.stanford.edu/svn/psdmrepo/CalibManager/trunk/src/SvnProps.py $"
        self.header   = "$Header:$"
        self.datelc   = "$LastChangedDate: 2014-07-02 14:46:47 -0700 (Wed, 02 Jul 2014) $"
        self.date     = "$Date: 2014-07-02 14:46:47 -0700 (Wed, 02 Jul 2014) $"
