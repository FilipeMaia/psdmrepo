...
CREATE  TABLE IF NOT EXISTS `translator_cpu` (
  ...
  `cpu_uri` TINYTEXT NOT NULL COMMENT 'Initially node:network but may be more general later.' ,
  `description` MEDIUMTEXT NOT NULL COMMENT 'More detailed description of the node.' ,
...
CREATE  TABLE IF NOT EXISTS `cache` (
  ...
  `offline_uri` MEDIUMTEXT NOT NULL COMMENT 'This is the directory URI as seen by the offline side.' ,
  `online_uri` MEDIUMTEXT NOT NULL COMMENT 'Directory URI as seen by the online side' ,
...
CREATE  TABLE IF NOT EXISTS `online_status_msg_def` (
  ...
  `message` MEDIUMTEXT NOT NULL COMMENT 'The message itself.' ,
  PRIMARY KEY (`id`) )
ENGINE = InnoDB
...
CREATE  TABLE IF NOT EXISTS `status_from_online` (
  ...
  `status_text` MEDIUMTEXT NOT NULL COMMENT 'Full text of the message.' ,
...
CREATE  TABLE IF NOT EXISTS `status_from_offline` (
  ...
  `status_text` MEDIUMTEXT NOT NULL COMMENT 'Full text of the status' ,
...
-- -----------------------------------------------------
SET AUTOCOMMIT=0;
INSERT INTO `cache` (`id`, `offline_uri`, `online_uri`, `avail_bytes`, `alloc_bytes`) VALUES (0, 'bbt-odf100.slac.stanford.edu/data', 'bbt-odf100.slac.stanford.edu/data', 1000000000, 0);
INSERT INTO `cache` (`id`, `offline_uri`, `online_uri`, `avail_bytes`, `alloc_bytes`) VALUES (0, 'bbt-odf100.slac.stanford.edu/data1', 'bbt-odf100.slac.stanford.edu/data1', 1000000000, 0);
