...
const size_t  SegGeometryEpix100V1::ROWS; //     = 704;
const size_t  SegGeometryEpix100V1::COLS; //     = 768;
const size_t  SegGeometryEpix100V1::ROWSHALF; // = 352;
const size_t  SegGeometryEpix100V1::COLSHALF; // = 384;
const size_t  SegGeometryEpix100V1::SIZE; //     = COLS*ROWS; 
const size_t  SegGeometryEpix100V1::NCORNERS; //    =   4;
...
const size_t SegGeometryEpix100V1::IND_CORNER[NCORNERS] = {0, COLS-1, (ROWS-1)*COLS, ROWS*COLS-1};
...
{ 
  ...
  return PSCalib::min_of_arr(&corner_coords[0], NCORNERS); 
}
...
{ 
  ...
  SegGeometry::pixel_coord_t corner_coords[NCORNERS];
  for (size_t i=0; i<NCORNERS; ++i) { corner_coords[i] = arr[IND_CORNER[i]]; }
  return PSCalib::max_of_arr(&corner_coords[0], NCORNERS); 
}
