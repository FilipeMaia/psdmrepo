...
@version $Id: SvnProps.py 8549 2014-07-04 00:05:02Z dubrovin@SLAC.STANFORD.EDU $
...
class SvnProps :
    def __init__(self) : 
        ...
        self.id       = "$Id: SvnProps.py 8549 2014-07-04 00:05:02Z dubrovin@SLAC.STANFORD.EDU $"
        self.headurl  = "$HeadURL: https://pswww.slac.stanford.edu/svn/psdmrepo/PSCalib/trunk/src/SvnProps.py $"
        self.header   = "$Header:$"
        self.datelc   = "$LastChangedDate: 2014-07-03 17:05:02 -0700 (Thu, 03 Jul 2014) $"
        self.date     = "$Date: 2014-07-03 17:05:02 -0700 (Thu, 03 Jul 2014) $"
