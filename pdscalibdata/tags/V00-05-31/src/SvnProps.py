...
@version $Id: SvnProps.py 8515 2014-06-30 23:20:37Z dubrovin@SLAC.STANFORD.EDU $
...
class SvnProps :
    def __init__(self) : 
        ...
        self.id       = "$Id: SvnProps.py 8515 2014-06-30 23:20:37Z dubrovin@SLAC.STANFORD.EDU $"
        self.headurl  = "$HeadURL: https://pswww.slac.stanford.edu/svn/psdmrepo/pdscalibdata/trunk/src/SvnProps.py $"
        self.header   = "$Header:$"
        self.datelc   = "$LastChangedDate: 2014-06-30 16:20:37 -0700 (Mon, 30 Jun 2014) $"
        self.date     = "$Date: 2014-06-30 16:20:37 -0700 (Mon, 30 Jun 2014) $"
