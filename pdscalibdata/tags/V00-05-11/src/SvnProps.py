...
@version $Id: SvnProps.py 8034 2014-04-19 00:51:18Z dubrovin@SLAC.STANFORD.EDU $
...
class SvnProps :
    ...
    id       = "$Id: SvnProps.py 8034 2014-04-19 00:51:18Z dubrovin@SLAC.STANFORD.EDU $"
    headurl  = "$HeadURL: https://pswww.slac.stanford.edu/svn/psdmrepo/pdscalibdata/trunk/src/SvnProps.py $"
    header   = "$Header:$"
    datelc   = "$LastChangedDate: 2014-04-18 17:51:18 -0700 (Fri, 18 Apr 2014) $"
    date     = "$Date: 2014-04-18 17:51:18 -0700 (Fri, 18 Apr 2014) $"
