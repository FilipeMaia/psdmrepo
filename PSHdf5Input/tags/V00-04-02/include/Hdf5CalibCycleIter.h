...
public:
  ...
  // Default constructor
  explicit Hdf5CalibCycleIter (const hdf5pp::Group& calibCycleGrp, int runNumber, unsigned schemaVersion, bool fullTsFormat) ;

  // Destructor
  ~Hdf5CalibCycleIter () ;

  /// get its group
  hdf5pp::Group& group() { return m_calibCycleGrp; }
