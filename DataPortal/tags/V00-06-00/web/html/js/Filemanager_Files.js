    ...
    this._create_summary_row = function () {
        ...
        var row = {
            title: {
                ...
                total_files:     '&nbsp;' ,
                total_gb:        '&nbsp;' ,
                short:           '<b>'+this._files_last_request.policies['MEDIUM-TERM'].retention_months+' months, disk</b>' ,
                short_overstay:  '&nbsp;' ,
                short_files:     '&nbsp;' ,
                short_gb:        '&nbsp;' ,
                medium:          '<b>'+this._files_last_request.policies['SHORT-TERM'].retention_months+' months, disk</b>' ,
                medium_overstay: '&nbsp;' ,
                medium_files:    '&nbsp;' ,
                medium_gb:       '&nbsp;' ,
