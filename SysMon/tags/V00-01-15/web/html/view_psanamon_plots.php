...
var Fwk = new FwkSimpleCreator(50) ;   // 20 Hz
...
$(function () {
    ...
    Fwk.register_handler(plot, function (now) {
        ...
        Fwk.web_service_GET (
            '/apps-dev/sysmon/ws/psanamon_plot_info.php' ,
            params ,
            function (data) {
            ...
            function (msg) {
                Fwk.report_error('failed to update the plot: '+msg) ;
                update_in_progress = false ;
            }
        ) ;
    }) ;
...
function display_plot(plot_info) {
    ...
    var img = new Image();
    img.src = 'data:'+plot_info.type+';base64,'+ plot_info.data ;
    console.log('img.width:',img.width,'img.height:',img.height)
    canvas.width = img.width
    canvas.height = img.height
    //cxt.drawImage(img, 0, 0, 200, 200, 0, 0, 640, 640) ;
...
<body>
    <div id="plotter" >
        ...
        <div class="plot-cont" >
            <div id="plot" class="plot" style="float:left;" >
                <img id="img" />
                <canvas>Your browser doesn't support HTML5</canvas></div>
