...
public:
  ...
  Timepix::ConfigV2::ReadoutSpeed readoutSpeed() const { return ReadoutSpeed(_readoutSpeed); }
  Timepix::ConfigV2::TriggerMode triggerMode() const { return TriggerMode(_triggerMode); }
...
public:
  ...
  Timepix::ConfigV3::ReadoutSpeed readoutSpeed() const { return ReadoutSpeed(_readoutSpeed); }
  Timepix::ConfigV3::TimepixMode timepixMode() const { return TimepixMode(_timepixMode); }
  int32_t timepixSpeed() const { return _timepixSpeed; }
  int32_t dac0Ikrum() const { return _dac0Ikrum; }
  int32_t dac0Disc() const { return _dac0Disc; }
  int32_t dac0Preamp() const { return _dac0Preamp; }
