...
EncoderDataV1::EncoderDataV1 ( const XtcType& data )
{
  ...
  m_data.encoder_count = data._encoder_count ;
}
...
EncoderDataV1::native_type()
{
  ...
  type.insert_native<uint32_t>( "_33mhz_timestamp", offsetof(EncoderDataV1_Data,_33mhz_timestamp) ) ;
  type.insert_native<uint32_t>( "encoder_count", offsetof(EncoderDataV1_Data,encoder_count) ) ;
