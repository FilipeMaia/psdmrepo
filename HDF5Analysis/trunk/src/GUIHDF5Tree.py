...
class GUIHDF5Tree ( QtGui.QMainWindow ) :
    ...
    def __init__(self, parent=None):
        ...
        self.icon_folder_open   = QtGui.QIcon("HDF5Analysis/src/icons/folder_open.gif")
        self.icon_folder_closed = QtGui.QIcon("HDF5Analysis/src/icons/folder_closed.gif")
        self.icon_data          = QtGui.QIcon("HDF5Analysis/src/icons/table.gif")
        self.icon_apply         = QtGui.QIcon("HDF5Analysis/src/icons/button_ok.png")
        self.icon_reset         = QtGui.QIcon("HDF5Analysis/src/icons/undo.png")
        self.icon_retreve       = QtGui.QIcon("HDF5Analysis/src/icons/redo.png")
        self.icon_exit          = QtGui.QIcon("HDF5Analysis/src/icons/exit.png")
        self.icon_expand        = QtGui.QIcon("HDF5Analysis/src/icons/folder_open.gif")
        self.icon_collapse      = QtGui.QIcon("HDF5Analysis/src/icons/folder_closed.gif")
        self.icon_expcoll       = self.icon_expand
        self.icon_expcheck      = QtGui.QIcon("HDF5Analysis/src/icons/folder_open_checked.png")
        self.icon_print         = QtGui.QIcon("HDF5Analysis/src/icons/contents.png")
