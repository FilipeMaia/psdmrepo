...
#  Class definition --
#---------------------
class GUIDataSetWindow ( QtGui.QWidget ) :
    """GUI manipulates with parameters for event selection in particular window of the image."""
    ...
    def __init__(self, parent=None, window=0):
        ...
        #self.titThreshold  = QtGui.QLabel('Threshold')
        ...
        grid.addWidget(self.butSelDataSet,       0, 1, 1, 5)
        ...
        self.vbox.addWidget(self.guitree)
        ...
        cp.confpars.dsWindowIsOpen = True
    ...
    def showToolTips(self):
        ...
        self.butSelDataSet.setToolTip('Select the dataset from the falling down menu.')
