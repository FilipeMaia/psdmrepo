...
import GUIDataSetWindow as guidswin
...
#  Class definition --
#---------------------
class GUIDataSets ( QtGui.QWidget ) :
    """This GUI is an envelop for all data set windows"""
    ...
    def __init__ (self, parent=None, app=None) :
        ...
        self.setWindowTitle('GUI for all data sets')
        ...
        self.guiWin = guidswin.GUIDataSetWindow() # for 0th window
    ...
    def closeEvent(self, event):
        #print 'closeEvent'
        cp.confpars.dsetsGUIIsOpen = False
