...
#        self.str_run_number_dark= self.declareParameter( name='RUN_NUMBER_DARK',   val_def='0014',         typ='str' ) 
        ...
        self.bat_data_start    = self.declareParameter( name='BATCH_DATA_START',         val_def=0,        typ='int' )
        ...
        self.bat_data_time     = self.declareParameter( name='BATCH_DATA_TIME' ,         val_def=-1,       typ='float' )
        self.bat_dark_start    = self.declareParameter( name='BATCH_DARK_START',         val_def=0,        typ='int' )
        ...
        self.bat_dark_time     = self.declareParameter( name='BATCH_DARK_TIME' ,         val_def=-1,       typ='float' )
        self.bat_flat_start    = self.declareParameter( name='BATCH_FLAT_START',         val_def=0,        typ='int' )
        ...
        self.bat_flat_time     = self.declareParameter( name='BATCH_FLAT_TIME' ,         val_def=-1,       typ='float' )
