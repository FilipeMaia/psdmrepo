...
class GUIImgSizePosition ( QtGui.QWidget ) :
    ...
    def __init__ ( self, parent=None ) :
        ...
        self.titImageSize  = QtGui.QLabel('CCD Image Size (pix):')
        ...
        self.titCameraPos  = QtGui.QLabel('CCD Posituion At Data Collection (mm):')
        ...
        self.grid.addWidget(self.edi_x_frame_pos,    1, 3)
        self.grid.addWidget(self.edi_y_frame_pos,    1, 5)

        self.grid.addWidget(self.titImageSize,       2, 0, 1,8)
