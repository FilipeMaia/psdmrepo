...
{
  XtcFileName name;
  BOOST_CHECK_NO_THROW( name = XtcFileName("/dir", 1, 2, 3, 4) ) ;
...
BOOST_AUTO_TEST_CASE( test_4 )
{
  ...
  BOOST_CHECK_NO_THROW( name = XtcFileName("/dir/", 1, 2, 3, 4) ) ;
  BOOST_CHECK_EQUAL ( name.path(), "/dir/e1-r0002-s03-c04.xtc" ) ;
  BOOST_CHECK_NO_THROW( name = XtcFileName("", 1, 2, 3, 4) ) ;
...
{
  XtcFileName name;
  BOOST_CHECK_NO_THROW( name = XtcFileName("/dir", 123456, 234567, 345678, 456789) ) ;
