        ...
        this.pretty_formatted = function () {
            if (!this._formatted) {
                ...
                for (var i = 0; i < list.length; ++i) {
                    var label = list[i] ;
                    var fixedPoints = _log10s(label.value).fract.log10 ;
        ...
        this.pretty_formatted_timestamps = function () {
            if (!this._formatted_timestamps) {
                ...
                for (var i = 0; i < list.length; ++i) {
                    ...
                    this._formatted_timestamps[':MM:SS']          .push({value: v, text: MM_SS}) ;
                    this._formatted_timestamps['HH:MM']           .push({value: v, text: HH_MM}) ;
                    this._formatted_timestamps['HH:MM:SS']        .push({value: v, text: HH_MM_SS}) ;
                    this._formatted_timestamps['YYYY-MM-DD HH:MM'].push({value: v, text: YYYY_MM_DD_HH_MM}) ;
                    this._formatted_timestamps['YYYY-MM-DD']      .push({value: v, text: YYYY_MM_DD}) ;
                    this._formatted_timestamps['YYYY-MM']         .push({value: v, text: YYYY_MM}) ;
                    this._formatted_timestamps['YYYY']            .push({value: v, text: YYYY}) ;
                }
            }
