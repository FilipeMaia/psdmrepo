...
void initializeHdfWriterMap( HdfWriterMap & mapping) {
  ...
  mapping[ & typeid(Psana::Bld::BldDataEBeamV5) ] = boost::make_shared<HdfWriterPsana<Psana::Bld::BldDataEBeamV5> >();
  ...
  mapping[ & typeid(ndarray< const int8_t, 1>) ] = boost::make_shared<HdfWriterNDArray< const int8_t, 1 > >();  
  mapping[ & typeid(ndarray< const int8_t, 2>) ] = boost::make_shared<HdfWriterNDArray< const int8_t, 2 > >();  
  mapping[ & typeid(ndarray< const int8_t, 3>) ] = boost::make_shared<HdfWriterNDArray< const int8_t, 3 > >();  
  mapping[ & typeid(ndarray< const int8_t, 4>) ] = boost::make_shared<HdfWriterNDArray< const int8_t, 4 > >();  
  mapping[ & typeid(ndarray< const int16_t, 1>) ] = boost::make_shared<HdfWriterNDArray< const int16_t, 1 > >();  
  mapping[ & typeid(ndarray< const int16_t, 2>) ] = boost::make_shared<HdfWriterNDArray< const int16_t, 2 > >();  
  mapping[ & typeid(ndarray< const int16_t, 3>) ] = boost::make_shared<HdfWriterNDArray< const int16_t, 3 > >();  
  mapping[ & typeid(ndarray< const int16_t, 4>) ] = boost::make_shared<HdfWriterNDArray< const int16_t, 4 > >();  
  mapping[ & typeid(ndarray< const int32_t, 1>) ] = boost::make_shared<HdfWriterNDArray< const int32_t, 1 > >();  
  mapping[ & typeid(ndarray< const int32_t, 2>) ] = boost::make_shared<HdfWriterNDArray< const int32_t, 2 > >();  
  mapping[ & typeid(ndarray< const int32_t, 3>) ] = boost::make_shared<HdfWriterNDArray< const int32_t, 3 > >();  
  mapping[ & typeid(ndarray< const int32_t, 4>) ] = boost::make_shared<HdfWriterNDArray< const int32_t, 4 > >();  
  mapping[ & typeid(ndarray< const int64_t, 1>) ] = boost::make_shared<HdfWriterNDArray< const int64_t, 1 > >();  
  mapping[ & typeid(ndarray< const int64_t, 2>) ] = boost::make_shared<HdfWriterNDArray< const int64_t, 2 > >();  
  mapping[ & typeid(ndarray< const int64_t, 3>) ] = boost::make_shared<HdfWriterNDArray< const int64_t, 3 > >();  
  mapping[ & typeid(ndarray< const int64_t, 4>) ] = boost::make_shared<HdfWriterNDArray< const int64_t, 4 > >();  
  mapping[ & typeid(ndarray< const uint8_t, 1>) ] = boost::make_shared<HdfWriterNDArray< const uint8_t, 1 > >();  
  mapping[ & typeid(ndarray< const uint8_t, 2>) ] = boost::make_shared<HdfWriterNDArray< const uint8_t, 2 > >();  
  mapping[ & typeid(ndarray< const uint8_t, 3>) ] = boost::make_shared<HdfWriterNDArray< const uint8_t, 3 > >();  
  mapping[ & typeid(ndarray< const uint8_t, 4>) ] = boost::make_shared<HdfWriterNDArray< const uint8_t, 4 > >();  
  mapping[ & typeid(ndarray< const uint16_t, 1>) ] = boost::make_shared<HdfWriterNDArray< const uint16_t, 1 > >();  
  mapping[ & typeid(ndarray< const uint16_t, 2>) ] = boost::make_shared<HdfWriterNDArray< const uint16_t, 2 > >();  
  mapping[ & typeid(ndarray< const uint16_t, 3>) ] = boost::make_shared<HdfWriterNDArray< const uint16_t, 3 > >();  
  mapping[ & typeid(ndarray< const uint16_t, 4>) ] = boost::make_shared<HdfWriterNDArray< const uint16_t, 4 > >();  
  mapping[ & typeid(ndarray< const uint32_t, 1>) ] = boost::make_shared<HdfWriterNDArray< const uint32_t, 1 > >();  
  mapping[ & typeid(ndarray< const uint32_t, 2>) ] = boost::make_shared<HdfWriterNDArray< const uint32_t, 2 > >();  
  mapping[ & typeid(ndarray< const uint32_t, 3>) ] = boost::make_shared<HdfWriterNDArray< const uint32_t, 3 > >();  
  mapping[ & typeid(ndarray< const uint32_t, 4>) ] = boost::make_shared<HdfWriterNDArray< const uint32_t, 4 > >();  
  mapping[ & typeid(ndarray< const uint64_t, 1>) ] = boost::make_shared<HdfWriterNDArray< const uint64_t, 1 > >();  
  mapping[ & typeid(ndarray< const uint64_t, 2>) ] = boost::make_shared<HdfWriterNDArray< const uint64_t, 2 > >();  
  mapping[ & typeid(ndarray< const uint64_t, 3>) ] = boost::make_shared<HdfWriterNDArray< const uint64_t, 3 > >();  
  mapping[ & typeid(ndarray< const uint64_t, 4>) ] = boost::make_shared<HdfWriterNDArray< const uint64_t, 4 > >();  
  mapping[ & typeid(ndarray< const float, 1>) ] = boost::make_shared<HdfWriterNDArray< const float, 1 > >();  
  mapping[ & typeid(ndarray< const float, 2>) ] = boost::make_shared<HdfWriterNDArray< const float, 2 > >();  
  mapping[ & typeid(ndarray< const float, 3>) ] = boost::make_shared<HdfWriterNDArray< const float, 3 > >();  
  mapping[ & typeid(ndarray< const float, 4>) ] = boost::make_shared<HdfWriterNDArray< const float, 4 > >();  
  mapping[ & typeid(ndarray< const double, 1>) ] = boost::make_shared<HdfWriterNDArray< const double, 1 > >();  
  mapping[ & typeid(ndarray< const double, 2>) ] = boost::make_shared<HdfWriterNDArray< const double, 2 > >();  
  mapping[ & typeid(ndarray< const double, 3>) ] = boost::make_shared<HdfWriterNDArray< const double, 3 > >();  
  mapping[ & typeid(ndarray< const double, 4>) ] = boost::make_shared<HdfWriterNDArray< const double, 4 > >();  
  // string               
