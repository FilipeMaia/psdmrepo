...
def plotAnalyzeExample(datasource, 
    ...
    psanaOptions = {
        ...
        #  Rolling average convergence factor (1/Nevents)
        'TimeTool.Analyze.ref_avg_fraction':0.5,
...
if __name__ == '__main__':
    ...
    parser.add_argument('-k', '--evrbykick', type=int, help="number of events to process, default is %d" % DEFAULT_EVR_BYKICK, default=DEFAULT_EVR_BYKICK)
    ...
    parser.add_argument('-d', '--datasource', type=str, help="example: exp=sxri0214:run=158")
