...
#ifndef PSANA_QUARTZ_DDL_WRAPPER_H
#define PSANA_QUARTZ_DDL_WRAPPER_H 1
...
public:
  ...
  Quartz::ConfigV1::Depth output_resolution() const { return o->output_resolution(); }
  Quartz::ConfigV1::Binning horizontal_binning() const { return o->horizontal_binning(); }
  Quartz::ConfigV1::Binning vertical_binning() const { return o->vertical_binning(); }
  Quartz::ConfigV1::Mirroring output_mirroring() const { return o->output_mirroring(); }
...
#endif // PSANA_QUARTZ_DDL_WRAPPER_H
