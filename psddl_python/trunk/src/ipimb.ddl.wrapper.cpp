...
PyObject* method_typeid_ConfigV1() {
  static PyObject* ptypeid = PyCObject_FromVoidPtr((void*)&typeid(Psana::Ipimb::ConfigV1), 0);
  Py_INCREF(ptypeid);
  return ptypeid;
}

PyObject* method_typeid_ConfigV2() {
  static PyObject* ptypeid = PyCObject_FromVoidPtr((void*)&typeid(Psana::Ipimb::ConfigV2), 0);
  Py_INCREF(ptypeid);
  return ptypeid;
}

PyObject* method_typeid_DataV1() {
  static PyObject* ptypeid = PyCObject_FromVoidPtr((void*)&typeid(Psana::Ipimb::DataV1), 0);
  Py_INCREF(ptypeid);
  return ptypeid;
}

PyObject* method_typeid_DataV2() {
  static PyObject* ptypeid = PyCObject_FromVoidPtr((void*)&typeid(Psana::Ipimb::DataV2), 0);
  Py_INCREF(ptypeid);
  return ptypeid;
}
