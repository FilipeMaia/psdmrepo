...
void store_ConfigV1_v0(const Psana::L3T::ConfigV1& obj, hdf5pp::Group group, bool append)
{
  {
...
void store_ConfigV1(const Psana::L3T::ConfigV1& obj, hdf5pp::Group group, int version, bool append)
{
  if (version < 0) version = 0;
  switch (version) {
  case 0:
...
void append(const Psana::L3T::ConfigV1& obj, hdf5pp::Group group, int version)
{
...
void store_DataV1_v0(const Psana::L3T::DataV1& obj, hdf5pp::Group group, bool append)
{
  {
...
void store_DataV1(const Psana::L3T::DataV1& obj, hdf5pp::Group group, int version, bool append)
{
  if (version < 0) version = 0;
  switch (version) {
  case 0:
...
void append(const Psana::L3T::DataV1& obj, hdf5pp::Group group, int version)
{
