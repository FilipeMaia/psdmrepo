...
hdf5pp::Type ns_SequencerConfigV1_v0_dataset_config_stored_type()
{
  ...
  type.insert("entries", offsetof(DsType, entries), hdf5pp::TypeTraits<EvrData::ns_SequencerEntry_v0::dataset_data>::stored_type());
  return type;
}
...
hdf5pp::Type ns_SequencerConfigV1_v0_dataset_config_native_type()
{
  ...
  type.insert("entries", offsetof(DsType, entries), hdf5pp::TypeTraits<EvrData::ns_SequencerEntry_v0::dataset_data>::native_type());
  return type;
}
...
ndarray<const Psana::EvrData::SequencerEntry, 1> SequencerConfigV1_v0::entries() const {
  ...
  if (m_ds_storage_config_entries.empty()) {
    unsigned shape[] = {this->length()};
    ndarray<Psana::EvrData::SequencerEntry, 1> tmparr(shape);
    std::copy(m_ds_config->entries, m_ds_config->entries+this->length(), tmparr.begin());
...
hdf5pp::Type ns_DataV3_v0_dataset_data_stored_type()
{
  ...
  hdf5pp::CompoundType type = hdf5pp::CompoundType::compoundType<DsType>();
  type.insert("fifoEvents", offsetof(DsType, fifoEvents), hdf5pp::TypeTraits<EvrData::ns_FIFOEvent_v0::dataset_data>::stored_type());
  return type;
}
...
hdf5pp::Type ns_DataV3_v0_dataset_data_native_type()
{
  typedef ns_DataV3_v0::dataset_data DsType;
  hdf5pp::CompoundType type = hdf5pp::CompoundType::compoundType<DsType>();
  type.insert("fifoEvents", offsetof(DsType, fifoEvents), hdf5pp::TypeTraits<EvrData::ns_FIFOEvent_v0::dataset_data>::native_type());
  return type;
}
