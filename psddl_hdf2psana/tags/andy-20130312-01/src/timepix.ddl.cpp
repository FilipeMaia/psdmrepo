...
hdf5pp::Type ns_ConfigV2_v0_dataset_config_stored_type()
{
  ...
  type.insert("chip0Name", offsetof(DsType, chip0Name), hdf5pp::TypeTraits<const char*>::stored_type(16));
  type.insert("chip1Name", offsetof(DsType, chip1Name), hdf5pp::TypeTraits<const char*>::stored_type(16));
  type.insert("chip2Name", offsetof(DsType, chip2Name), hdf5pp::TypeTraits<const char*>::stored_type(16));
  type.insert("chip3Name", offsetof(DsType, chip3Name), hdf5pp::TypeTraits<const char*>::stored_type(16));
...
hdf5pp::Type ns_ConfigV2_v0_dataset_config_native_type()
{
  ...
  type.insert("chip0Name", offsetof(DsType, chip0Name), hdf5pp::TypeTraits<const char*>::native_type(16));
  type.insert("chip1Name", offsetof(DsType, chip1Name), hdf5pp::TypeTraits<const char*>::native_type(16));
  type.insert("chip2Name", offsetof(DsType, chip2Name), hdf5pp::TypeTraits<const char*>::native_type(16));
  type.insert("chip3Name", offsetof(DsType, chip3Name), hdf5pp::TypeTraits<const char*>::native_type(16));
