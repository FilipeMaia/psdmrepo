...
hdf5pp::Type ns_ConfigV1_v0_dataset_config_stored_type()
{
  ...
  type.insert("voltageRange", offsetof(DsType, voltageRange), hdf5pp::TypeTraits<uint16_t>::stored_type());
  ...
  type.insert("inputMode", offsetof(DsType, inputMode), hdf5pp::TypeTraits<uint16_t>::stored_type());
  type.insert("triggerMode", offsetof(DsType, triggerMode), hdf5pp::TypeTraits<uint16_t>::stored_type());
  type.insert("dataFormat", offsetof(DsType, dataFormat), hdf5pp::TypeTraits<uint16_t>::stored_type());
  ...
  type.insert("numChannels", offsetof(DsType, numChannels), hdf5pp::TypeTraits<uint16_t>::stored_type());
  return type;
}
...
hdf5pp::Type ns_ConfigV1_v0_dataset_config_native_type()
{
  typedef ns_ConfigV1_v0::dataset_config DsType;
  hdf5pp::CompoundType type = hdf5pp::CompoundType::compoundType<DsType>();
  type.insert("voltageRange", offsetof(DsType, voltageRange), hdf5pp::TypeTraits<uint16_t>::native_type());
  ...
  type.insert("inputMode", offsetof(DsType, inputMode), hdf5pp::TypeTraits<uint16_t>::native_type());
  type.insert("triggerMode", offsetof(DsType, triggerMode), hdf5pp::TypeTraits<uint16_t>::native_type());
  type.insert("dataFormat", offsetof(DsType, dataFormat), hdf5pp::TypeTraits<uint16_t>::native_type());
  ...
  type.insert("numChannels", offsetof(DsType, numChannels), hdf5pp::TypeTraits<uint16_t>::native_type());
  return type;
}
...
uint16_t ConfigV1_v0::numChannels() const {
  if (not m_ds_config.get()) read_ds_config();
...
hdf5pp::Type ns_DataV1_v0_dataset_timestamp_stored_type()
{
  ...
  hdf5pp::CompoundType type = hdf5pp::CompoundType::compoundType<DsType>();
  type.insert("timestamp", offsetof(DsType, timestamp), hdf5pp::TypeTraits<uint16_t>::stored_type());
  return type;
}
...
hdf5pp::Type ns_DataV1_v0_dataset_timestamp_native_type()
{
  typedef ns_DataV1_v0::dataset_timestamp DsType;
  hdf5pp::CompoundType type = hdf5pp::CompoundType::compoundType<DsType>();
  type.insert("timestamp", offsetof(DsType, timestamp), hdf5pp::TypeTraits<uint16_t>::native_type());
  return type;
}
