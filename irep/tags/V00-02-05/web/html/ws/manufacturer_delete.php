...
/**
 * This service will delete the specified manufacturer and return an updated dictionary.
 * 
 * Parameters:
 * 
 *   <id>
...
\DataPortal\ServiceJSON::run_handler ('GET', function ($SVC) {
    ...
    if ($SVC->irep()->find_manufacturer_by_id($id))
        $SVC->irep()->delete_manufacturer($id) ;
