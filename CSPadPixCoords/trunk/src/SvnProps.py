...
@version $Id: SvnProps.py 8288 2014-05-28 18:08:21Z dubrovin@SLAC.STANFORD.EDU $
...
class SvnProps :
    def __init__(self) : 
        ...
        self.id       = "$Id: SvnProps.py 8288 2014-05-28 18:08:21Z dubrovin@SLAC.STANFORD.EDU $"
        self.headurl  = "$HeadURL: https://pswww.slac.stanford.edu/svn/psdmrepo/CSPadPixCoords/trunk/src/SvnProps.py $"
        self.header   = "$Header: https://pswww.slac.stanford.edu/svn/psdmrepo/CSPadPixCoords/trunk/src/SvnProps.py 8154 2014-05-06 16:57:15Z dubrovin@SLAC.STANFORD.EDU $"
        self.datelc   = "$LastChangedDate: 2014-05-28 11:08:21 -0700 (Wed, 28 May 2014) $"
        self.date     = "$Date: 2014-05-28 11:08:21 -0700 (Wed, 28 May 2014) $"
