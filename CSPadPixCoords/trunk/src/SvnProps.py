...
@version $Id: SvnProps.py 8153 2014-05-06 16:56:41Z dubrovin@SLAC.STANFORD.EDU $
...
class SvnProps :
    def __init__(self) : 
        ...
        self.revision = "$Revision: 8153 $"
        self.author   = "$Author: dubrovin@SLAC.STANFORD.EDU $"
        self.id       = "$Id: SvnProps.py 8153 2014-05-06 16:56:41Z dubrovin@SLAC.STANFORD.EDU $"
        self.headurl  = "$HeadURL: https://pswww.slac.stanford.edu/svn/psdmrepo/CSPadPixCoords/trunk/src/SvnProps.py $"
        self.header   = "$Header$"
        self.datelc   = "$LastChangedDate: 2014-05-06 09:56:41 -0700 (Tue, 06 May 2014) $"
        self.date     = "$Date: 2014-05-06 09:56:41 -0700 (Tue, 06 May 2014) $"
