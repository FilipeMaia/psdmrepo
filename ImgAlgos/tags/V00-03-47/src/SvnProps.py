...
@version $Id: SvnProps.py 8390 2014-06-13 16:56:28Z dubrovin@SLAC.STANFORD.EDU $
...
class SvnProps :
    def __init__(self) : 
        ...
        self.id       = "$Id: SvnProps.py 8390 2014-06-13 16:56:28Z dubrovin@SLAC.STANFORD.EDU $"
        self.headurl  = "$HeadURL: https://pswww.slac.stanford.edu/svn/psdmrepo/ImgAlgos/trunk/src/SvnProps.py $"
        self.header   = "$Header:$"
        self.datelc   = "$LastChangedDate: 2014-06-13 09:56:28 -0700 (Fri, 13 Jun 2014) $"
        self.date     = "$Date: 2014-06-13 09:56:28 -0700 (Fri, 13 Jun 2014) $"
