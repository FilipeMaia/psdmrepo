...
@version $Id: SvnProps.py 8527 2014-07-03 00:01:08Z dubrovin@SLAC.STANFORD.EDU $
...
class SvnProps :
    def __init__(self) : 
        ...
        self.id       = "$Id: SvnProps.py 8527 2014-07-03 00:01:08Z dubrovin@SLAC.STANFORD.EDU $"
        self.headurl  = "$HeadURL: https://pswww.slac.stanford.edu/svn/psdmrepo/ImgAlgos/trunk/src/SvnProps.py $"
        self.header   = "$Header:$"
        self.datelc   = "$LastChangedDate: 2014-07-02 17:01:08 -0700 (Wed, 02 Jul 2014) $"
        self.date     = "$Date: 2014-07-02 17:01:08 -0700 (Wed, 02 Jul 2014) $"
