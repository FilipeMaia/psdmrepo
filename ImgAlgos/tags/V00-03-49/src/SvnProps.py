...
@version $Id: SvnProps.py 8471 2014-06-24 22:59:54Z dubrovin@SLAC.STANFORD.EDU $
...
class SvnProps :
    def __init__(self) : 
        ...
        self.id       = "$Id: SvnProps.py 8471 2014-06-24 22:59:54Z dubrovin@SLAC.STANFORD.EDU $"
        self.headurl  = "$HeadURL: https://pswww.slac.stanford.edu/svn/psdmrepo/ImgAlgos/trunk/src/SvnProps.py $"
        self.header   = "$Header:$"
        self.datelc   = "$LastChangedDate: 2014-06-24 15:59:54 -0700 (Tue, 24 Jun 2014) $"
        self.date     = "$Date: 2014-06-24 15:59:54 -0700 (Tue, 24 Jun 2014) $"
