#ifndef IMGALGOS_GEOMETRYACCESS_H
#define IMGALGOS_GEOMETRYACCESS_H
 ...
 *  ImgAlgos::GeometryAccess geometry(path, print_bits);
 *  @endcode
 *
 *  @li Access methods
 *  @code
...
private:
  ...
  static const std::string name() {return "ImgAlgos";}
...
#endif // IMGALGOS_GEOMETRYACCESS_H
