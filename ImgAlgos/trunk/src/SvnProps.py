...
@version $Id: SvnProps.py 8678 2014-07-18 23:01:04Z dubrovin@SLAC.STANFORD.EDU $
...
class SvnProps :
    def __init__(self) : 
        ...
        self.id       = "$Id: SvnProps.py 8678 2014-07-18 23:01:04Z dubrovin@SLAC.STANFORD.EDU $"
        self.headurl  = "$HeadURL: https://pswww.slac.stanford.edu/svn/psdmrepo/ImgAlgos/trunk/src/SvnProps.py $"
        self.header   = "$Header:$"
        self.datelc   = "$LastChangedDate: 2014-07-18 16:01:04 -0700 (Fri, 18 Jul 2014) $"
        self.date     = "$Date: 2014-07-18 16:01:04 -0700 (Fri, 18 Jul 2014) $"
