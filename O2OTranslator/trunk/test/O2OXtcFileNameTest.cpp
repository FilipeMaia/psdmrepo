...
{
  O2OXtcFileName name;
  BOOST_CHECK_NO_THROW( name = O2OXtcFileName("/dir/e1_r2_s3_c4.xtc") ) ;
  BOOST_CHECK_EQUAL ( name.basename(), "e1_r2_s3_c4.xtc" ) ;
...
{
  O2OXtcFileName name;
  BOOST_CHECK_NO_THROW( name = O2OXtcFileName("/dir/e123456_r234567_s345678_c456789.xtc") ) ;
  BOOST_CHECK_EQUAL ( name.basename(), "e123456_r234567_s345678_c456789.xtc" ) ;
...
BOOST_AUTO_TEST_CASE( test_fail_1 )
{
  ...
  BOOST_CHECK_NO_THROW( name = O2OXtcFileName("/dir/e1_r2_s3c4.xtc") ) ;
  BOOST_CHECK_EQUAL ( name.expNum(), 0U ) ;
  BOOST_CHECK_EQUAL ( name.run(), 0U ) ;
  BOOST_CHECK_EQUAL ( name.stream(), 0U ) ;
  BOOST_CHECK_EQUAL ( name.chunk(), 0U ) ;
  BOOST_CHECK_NO_THROW( name = O2OXtcFileName("/dir/e_1_r2_s3_c4.xtc") ) ;
  BOOST_CHECK_EQUAL ( name.expNum(), 0U ) ;
  BOOST_CHECK_EQUAL ( name.run(), 0U ) ;
  BOOST_CHECK_EQUAL ( name.stream(), 0U ) ;
  BOOST_CHECK_EQUAL ( name.chunk(), 0U ) ;
...
BOOST_AUTO_TEST_CASE( test_cmp_1 )
{
  ...
  BOOST_CHECK_NO_THROW( name1 = O2OXtcFileName("/dir/e1_r2_s3_c4.xtc") ) ;
  BOOST_CHECK_NO_THROW( name2 = O2OXtcFileName("/dir/e1_r2_s3_c5.xtc") ) ;
...
BOOST_AUTO_TEST_CASE( test_cmp_2 )
{
  O2OXtcFileName name1;
  O2OXtcFileName name2;
  BOOST_CHECK_NO_THROW( name1 = O2OXtcFileName("/dir1/e1_r2_s3_c4.xtc") ) ;
  BOOST_CHECK_NO_THROW( name2 = O2OXtcFileName("/dir2/e1_r2_s4_c4.xtc") ) ;
  BOOST_CHECK( name1 < name2 ) ;
  BOOST_CHECK( not ( name1 < name1 ) ) ;
  BOOST_CHECK( not ( name2 < name1 ) ) ;
}
...
BOOST_AUTO_TEST_CASE( test_cmp_3 )
{
  O2OXtcFileName name1;
  O2OXtcFileName name2;
  BOOST_CHECK_NO_THROW( name1 = O2OXtcFileName("/dir2/e1_r2_s3_c4.xtc") ) ;
  BOOST_CHECK_NO_THROW( name2 = O2OXtcFileName("/dir1/e1_r3_s3_c4.xtc") ) ;
  BOOST_CHECK( name1 < name2 ) ;
  BOOST_CHECK( not ( name1 < name1 ) ) ;
  BOOST_CHECK( not ( name2 < name1 ) ) ;
}
...
BOOST_AUTO_TEST_CASE( test_cmp_4 )
{
  O2OXtcFileName name1;
  O2OXtcFileName name2;
  BOOST_CHECK_NO_THROW( name1 = O2OXtcFileName("/dir3/e1_r2_s3_c4.xtc") ) ;
  BOOST_CHECK_NO_THROW( name2 = O2OXtcFileName("/dir345/e2_r2_s3_c4.xtc") ) ;
  BOOST_CHECK( name1 < name2 ) ;
  BOOST_CHECK( not ( name1 < name1 ) ) ;
  BOOST_CHECK( not ( name2 < name1 ) ) ;
}
