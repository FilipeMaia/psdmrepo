...
CsPadElementV2Cvt::CsPadElementV2Cvt ( const std::string& typeGroupName,
                                   ...
                                   hsize_t chunk_size,
                                   int deflate )
  : EvtDataTypeCvt<Pds::CsPad::ElementV2>(typeGroupName, chunk_size, deflate)
...
void
CsPadElementV2Cvt::makeContainers(hsize_t chunk_size, int deflate,
    const Pds::TypeId& typeId, const O2OXtcSrc& src)
{
  // create container for frames
  CvtDataContFactoryTyped<H5DataTypes::CsPadElementV2> elContFactory( "element", chunk_size, deflate, true ) ;
...
void
CsPadElementV2Cvt::closeContainers( hdf5pp::Group group )
{
