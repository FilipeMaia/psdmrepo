#ifndef O2OTRANSLATOR_OCEANOPTICSDATAV2CVT_H
#define O2OTRANSLATOR_OCEANOPTICSDATAV2CVT_H
 ...
 *
 *  @brief Special converter class for Pds::OceanOptics::DataV2 XTC class
 *
...
class OceanOpticsDataV2Cvt : public EvtDataTypeCvt<Pds::OceanOptics::DataV2> {
public:

  typedef Pds::OceanOptics::DataV2 XtcType ;
  typedef H5DataTypes::OceanOpticsDataV2 H5Type ;

  // Default constructor
  OceanOpticsDataV2Cvt(const hdf5pp::Group& group,
...
#endif // O2OTRANSLATOR_OCEANOPTICSDATAV2CVT_H
