 ...
 */
void
O2OCvtFactory::makeConverters(CvtMap& cvtMap, ConfigObjectStore& configStore, CalibObjectStore& calibStore,
    const O2OMetaData& metadata, int compression)
{
  // instantiate all factories
  DataTypeCvtPtr converter ;

  ::registerConfigCvt<H5DataTypes::AcqirisConfigV1>(cvtMap, "Acqiris::ConfigV1", Pds::TypeId::Id_AcqConfig, 1);

  ::registerConfigCvt<H5DataTypes::AcqirisTdcConfigV1>(cvtMap, "Acqiris::AcqirisTdcConfigV1", Pds::TypeId::Id_AcqTdcConfig, 1);

  ::registerConfigCvt<H5DataTypes::Opal1kConfigV1>(cvtMap, "Opal1k::ConfigV1", Pds::TypeId::Id_Opal1kConfig, 1);

  ::registerConfigCvt<H5DataTypes::PulnixTM6740ConfigV1>(cvtMap, "Pulnix::TM6740ConfigV1", Pds::TypeId::Id_TM6740Config, 1);
  ::registerConfigCvt<H5DataTypes::PulnixTM6740ConfigV2>(cvtMap, "Pulnix::TM6740ConfigV2", Pds::TypeId::Id_TM6740Config, 2);

  ::registerConfigCvt<H5DataTypes::CameraFrameFexConfigV1>(cvtMap, "Camera::FrameFexConfigV1", Pds::TypeId::Id_FrameFexConfig, 1);

  ::registerConfigCvt<H5DataTypes::EvrConfigV1>(cvtMap, "EvrData::ConfigV1", Pds::TypeId::Id_EvrConfig, 1);
  ::registerConfigCvt<H5DataTypes::EvrConfigV2>(cvtMap, "EvrData::ConfigV2", Pds::TypeId::Id_EvrConfig, 2);
  ::registerConfigCvt<H5DataTypes::EvrConfigV3>(cvtMap, "EvrData::ConfigV3", Pds::TypeId::Id_EvrConfig, 3);
  ::registerConfigCvt<H5DataTypes::EvrConfigV4>(cvtMap, "EvrData::ConfigV4", Pds::TypeId::Id_EvrConfig, 4);
  ::registerConfigCvt<H5DataTypes::EvrConfigV5>(cvtMap, "EvrData::ConfigV5", Pds::TypeId::Id_EvrConfig, 5);
  ::registerConfigCvt<H5DataTypes::EvrConfigV6>(cvtMap, "EvrData::ConfigV6", Pds::TypeId::Id_EvrConfig, 6);

  ::registerConfigCvt<H5DataTypes::EvrIOConfigV1>(cvtMap, "EvrData::IOConfigV1", Pds::TypeId::Id_EvrIOConfig, 1);

  ::registerConfigCvt<H5DataTypes::ControlDataConfigV1>(cvtMap, "ControlData::ConfigV1", Pds::TypeId::Id_ControlConfig, 1);

  ::registerConfigCvt<H5DataTypes::PnCCDConfigV1>(cvtMap, "PNCCD::ConfigV1", Pds::TypeId::Id_pnCCDconfig, 1);
  ::registerConfigCvt<H5DataTypes::PnCCDConfigV2>(cvtMap, "PNCCD::ConfigV2", Pds::TypeId::Id_pnCCDconfig, 2);

  ::registerConfigCvt<H5DataTypes::PrincetonConfigV1>(cvtMap, "Princeton::ConfigV1", Pds::TypeId::Id_PrincetonConfig, 1);
  ::registerConfigCvt<H5DataTypes::PrincetonConfigV2>(cvtMap, "Princeton::ConfigV2", Pds::TypeId::Id_PrincetonConfig, 2);
  ::registerConfigCvt<H5DataTypes::PrincetonConfigV3>(cvtMap, "Princeton::ConfigV3", Pds::TypeId::Id_PrincetonConfig, 3);

  ::registerConfigCvt<H5DataTypes::FccdConfigV1>(cvtMap, "FCCD::FccdConfigV1", Pds::TypeId::Id_FccdConfig, 1);
  ::registerConfigCvt<H5DataTypes::FccdConfigV2>(cvtMap, "FCCD::FccdConfigV2", Pds::TypeId::Id_FccdConfig, 2);

  ::registerConfigCvt<H5DataTypes::IpimbConfigV1>(cvtMap, "Ipimb::ConfigV1", Pds::TypeId::Id_IpimbConfig, 1);
  ::registerConfigCvt<H5DataTypes::IpimbConfigV2>(cvtMap, "Ipimb::ConfigV2", Pds::TypeId::Id_IpimbConfig, 2);

  ::registerConfigCvt<H5DataTypes::EncoderConfigV1>(cvtMap, "Encoder::ConfigV1", Pds::TypeId::Id_EncoderConfig, 1);
  ::registerConfigCvt<H5DataTypes::EncoderConfigV2>(cvtMap, "Encoder::ConfigV2", Pds::TypeId::Id_EncoderConfig, 2);

  ::registerConfigCvt<H5DataTypes::LusiDiodeFexConfigV1>(cvtMap, "Lusi::DiodeFexConfigV1", Pds::TypeId::Id_DiodeFexConfig, 1);
  ::registerConfigCvt<H5DataTypes::LusiDiodeFexConfigV2>(cvtMap, "Lusi::DiodeFexConfigV2", Pds::TypeId::Id_DiodeFexConfig, 2);

  ::registerConfigCvt<H5DataTypes::LusiIpmFexConfigV1>(cvtMap, "Lusi::IpmFexConfigV1", Pds::TypeId::Id_IpmFexConfig, 1);
  ::registerConfigCvt<H5DataTypes::LusiIpmFexConfigV2>(cvtMap, "Lusi::IpmFexConfigV2", Pds::TypeId::Id_IpmFexConfig, 2);

  ::registerConfigCvt<H5DataTypes::LusiPimImageConfigV1>(cvtMap, "Lusi::PimImageConfigV1", Pds::TypeId::Id_PimImageConfig, 1);

  ::registerConfigCvt<H5DataTypes::CsPadConfigV1>(cvtMap, "CsPad::ConfigV1", Pds::TypeId::Id_CspadConfig, 1);
  ::registerConfigCvt<H5DataTypes::CsPadConfigV2>(cvtMap, "CsPad::ConfigV2", Pds::TypeId::Id_CspadConfig, 2);
  ::registerConfigCvt<H5DataTypes::CsPadConfigV3>(cvtMap, "CsPad::ConfigV3", Pds::TypeId::Id_CspadConfig, 3);
  ::registerConfigCvt<H5DataTypes::CsPadConfigV4>(cvtMap, "CsPad::ConfigV4", Pds::TypeId::Id_CspadConfig, 4);

  ::registerConfigCvt<H5DataTypes::Gsc16aiConfigV1>(cvtMap, "Gsc16ai::ConfigV1", Pds::TypeId::Id_Gsc16aiConfig, 1);

  ::registerConfigCvt<H5DataTypes::TimepixConfigV1>(cvtMap, "Timepix::ConfigV1", Pds::TypeId::Id_TimepixConfig, 1);
  ::registerConfigCvt<H5DataTypes::TimepixConfigV2>(cvtMap, "Timepix::ConfigV2", Pds::TypeId::Id_TimepixConfig, 2);

  ::registerConfigCvt<H5DataTypes::CsPad2x2ConfigV1>(cvtMap, "CsPad2x2::ConfigV1", Pds::TypeId::Id_Cspad2x2Config, 1);

  ::registerConfigCvt<H5DataTypes::OceanOpticsConfigV1>(cvtMap, "OceanOptics::ConfigV1", Pds::TypeId::Id_OceanOpticsConfig, 1);

  ::registerConfigCvt<H5DataTypes::FliConfigV1>(cvtMap, "Fli::ConfigV1", Pds::TypeId::Id_FliConfig, 1);

  ::registerConfigCvt<H5DataTypes::QuartzConfigV1>(cvtMap, "Quartz::ConfigV1", Pds::TypeId::Id_QuartzConfig,1);

  // special converter object for CsPad calibration data
  converter.reset(new CsPadCalibV1Cvt("CsPad::CalibV1", metadata, calibStore));
  ::registerCvt(cvtMap, Pds::TypeId::Id_CspadConfig, 1, converter);
  ::registerCvt(cvtMap, Pds::TypeId::Id_CspadConfig, 2, converter);
  ::registerCvt(cvtMap, Pds::TypeId::Id_CspadConfig, 3, converter);

  // special converter object for CsPad calibration data
  converter.reset(new CsPad2x2CalibV1Cvt("CsPad2x2::CalibV1", metadata, calibStore));
  ::registerCvt(cvtMap, Pds::TypeId::Id_Cspad2x2Config, 1, converter);
  ...
  ::registerCvt(cvtMap, Pds::TypeId::Id_TwoDGaussian, 1, converter);
  ...
  ::registerCvt(cvtMap, Pds::TypeId::Id_FEEGasDetEnergy, 0, converter);

  // version for this type is 0
  converter = make_shared<EvtDataTypeCvtDef<H5DataTypes::BldDataEBeamV0> >(
      "Bld::BldDataEBeamV0", chunk_size, compression);
  ::registerCvt(cvtMap, Pds::TypeId::Id_EBeam, 0, converter);
  ...
  ::registerCvt(cvtMap, Pds::TypeId::Id_EBeam, 1, converter);
  ...
  ::registerCvt(cvtMap, Pds::TypeId::Id_EBeam, 2, converter);
  ...
  ::registerCvt(cvtMap, Pds::TypeId::Id_AcqWaveform, 1, converter);
  ...
  ::registerCvt(cvtMap, Pds::TypeId::Id_AcqTdcData, 1, converter);
  ...
  ::registerCvt(cvtMap, Pds::TypeId::Id_EvrData, 3, converter);
  ...
  ::registerCvt(cvtMap, Pds::TypeId::Id_pnCCDframe, 1, converter);
  ...
  ::registerCvt(cvtMap, Pds::TypeId::Id_PrincetonFrame, 1, converter);

  // version for this type is 1
  converter = make_shared<EvtDataTypeCvtDef<H5DataTypes::PrincetonInfoV1> >(
      "Princeton::InfoV1", chunk_size, compression);
  ::registerCvt(cvtMap, Pds::TypeId::Id_PrincetonInfo, 1, converter);
...
//  ::registerCvt(cvtMap, Pds::TypeId::Id_Epics, 1, converter);
  ...
  ::registerCvt(cvtMap, Pds::TypeId::Id_DiodeFex, 1, converter);

  // version for this type is 1
  converter = make_shared<EvtDataTypeCvtDef<H5DataTypes::LusiIpmFexV1> >(
      "Lusi::IpmFexV1", chunk_size, compression);
  ::registerCvt(cvtMap, Pds::TypeId::Id_IpmFex, 1, converter);
  ...
  ::registerCvt(cvtMap, Pds::TypeId::Id_CspadElement, 1, converter);
  ...
  converter = make_shared<CsPadElementV2Cvt>("CsPad::ElementV2", configStore,
                                           calibStore, chunk_size, compression);
  ::registerCvt(cvtMap, Pds::TypeId::Id_CspadElement, 2, converter);
  ...
  ::registerCvt(cvtMap, Pds::TypeId::Id_Cspad2x2Element, 1, converter);
  ...
  ::registerCvt(cvtMap, Pds::TypeId::Id_Gsc16aiData, 1, converter);
  ...
  ::registerCvt(cvtMap, Pds::TypeId::Id_OceanOpticsData, 1, converter);
  ...
  ::registerCvt(cvtMap, Pds::TypeId::Id_FliFrame, 1, converter);
