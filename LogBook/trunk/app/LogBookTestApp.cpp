...
LogBookTestApp::cmd_help ()
{
    cout << "SYNTAX:\n"
         ...
         << "\n"
         << "  add_run       <instrument> <experiment> <run> {DATA|CALIB|TEST} <begn_time> <end_time>\n"
         << "  begin_run     <instrument> <experiment> <run> {DATA|CALIB|TEST} <begn_time>\n"
         ...
         << "\n"
         << "  save_files       <instrument> <experiment> <run> {DATA|CALIB|TEST}\n"
         << "  save_files_m     <instrument> <experiment> <run> {DATA|CALIB|TEST} [ <file1> {XTC|EPICS} ] [ <file>2 {XTC|EPICS} ] ...\n"
         << "\n"
