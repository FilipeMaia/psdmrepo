...
/*
 * Create a new message (in behalf of the Poster)
 */
...
\DataPortal\ServiceJSON::run_handler ('POST', function ($SVC) {
    ...
    $author          = trim($SVC->required_str('author_account')) ;
    ...
    $experiment = $SVC->safe_assign ($SVC->logbook()->find_experiment($instrument_name, $experiment_name) ,
                                     'no such experiment') ;
