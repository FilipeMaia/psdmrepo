...
/*
 * Finish the specified run for an experiment.
 * 
...
DataPortal\ServiceJSON::run_handler ('GET', function ($SVC) {
    ...
    $run = $SVC->safe_assign ($experiment->find_run_by_num($num) ,
                              "no run number {$num} started at experiment id={$exper_id}") ;

    $run->close(LusiTime\LusiTime::now()) ;
