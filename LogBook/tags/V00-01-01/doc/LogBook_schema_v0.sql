...
-- -----------------------------------------------------
-- Table `LOGBOOK`.`EXPERIMENT`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `LOGBOOK`.`EXPERIMENT` ;

CREATE  TABLE IF NOT EXISTS `LOGBOOK`.`EXPERIMENT` (
...
CREATE  TABLE IF NOT EXISTS `LOGBOOK`.`HEADER` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `exper_id` INT NOT NULL ,
  `relevance_time` BIGINT UNSIGNED NOT NULL ,
  INDEX `HEADER_FK_1` (`exper_id` ASC) ,
  PRIMARY KEY (`id`) ,
