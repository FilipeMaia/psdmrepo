...
public:
  ...
  enum {
    TypeId = Pds::TypeId::Id_AcqConfig /**< XTC type ID value (from Pds::TypeId class) */
  };
  enum {
    MaxChan = 20 /**< Maximum number of the configured channels. */
  };
  virtual ~ConfigV1();
  ...
  /** Method which returns the shape (dimensions) of the data returned by vert() method. */
...
public:
  ...
  enum {
    TypeId = Pds::TypeId::Id_AcqWaveform /**< XTC type ID value (from Pds::TypeId class) */
  };
  virtual ~DataDescV1();
...
public:
  ...
  enum {
    TypeId = Pds::TypeId::Id_AcqTdcConfig /**< XTC type ID value (from Pds::TypeId class) */
  };
  enum {
    NChannels = 8 /**< Total number of channel configurations. */
  };
  enum {
    NAuxIO = 2 /**< Total number of auxiliary IO configurations. */
  };
  virtual ~TdcConfigV1();
  ...
  /** Method which returns the shape (dimensions) of the data returned by auxio() method. */
...
public:
  ...
  enum {
    TypeId = Pds::TypeId::Id_AcqTdcData /**< XTC type ID value (from Pds::TypeId class) */
  };
  virtual ~TdcDataV1();
